...
\end{align*}
%H(l,g) &:=_1 \lambda n\ .\ p_n+M_0(p_n,n,l)+g(M_0(p_n,n,l)),\\
%p_n&:\equiv P_0(l,F(l,g,n)),\\
%&H(l,g) :=_1 \lambda n'\ .\ \max\{ p+M_0(l,n,p)+g(M_0(l,n,p)) | p\leq P_0(l,F(l,g,n)) , n\leq n' \}\\
where
\begin{align*}
...
From now on, we assume that the assumptions of the theorem hold and use the terms as they are defined in the theorem. 
...
%1 - \sum^{m-1}_{i=0} \tilde{\tup s}(i)&\Tif\ n= m\wedge 0\leq_\QQ s_m \wedge s_m+\sum^{m-1}_{i=0} \tilde {\tup s}(i)\neq_\QQ 1,\\
