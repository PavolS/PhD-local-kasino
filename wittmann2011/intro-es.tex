...
\label{f:METtree}
\end{figure}
\footnotetext{Originally submitted in 2008. Thereafter Kohlenbach and Leu{\c{s}}tean 
extended the result to uniformly convex spaces and gave a better bound.} \\					
